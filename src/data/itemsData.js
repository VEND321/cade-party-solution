...
// Dessert Stands & Trays imports
import cylinderDessertStand from "../assets/3-tier-cylinder-desert-stand.jpg";
import twoTierDessert from "../assets/2-tier-desert.jpg";
import woodenDessertStand from "../assets/3-tier-wooden-desert-stand.jpg";
import marbleDessertStand from "../assets/3-tier-desert-marble-design.jpg";
import fruitStand from "../assets/fruit-stand.jpg";
import blackDessertStand from "../assets/black-desert-stand.jpg";
import whiteGoldRimTray from "../assets/white-gold-rim-desert-tray.jpg";
import glassTray from "../assets/glass-tray.jpg";
import cakeTray from "../assets/cake-tray.jpg";
import goldDessertTray from "../assets/gold-desert-tray.jpg";
import basketDessertTray from "../assets/basket-desert-tray.jpg";
import rectangularTray from "../assets/rectangular-tray.jpg";
import roundTray from "../assets/round-tray.jpg";
...
//Trolleys
import goldTrolleys from "../assets/goldtrolleys.jpg";
import silverTrolley from "../assets/silver-trolley.jpg";
...
export const categoriesData = [
  ...
  {
    id: "dessert-stands-trays",
    label: "Dessert Stands & Trays",
    items: [
      {
      ...
      {
        id: "2-tier-dessert",
        name: "2 Tier Dessert Stand",
        price: 2500,
        unit: "each",
        image: twoTierDessert,
        description: "Beautiful 2 tier dessert stand",
      },
      {
        id: "3-tier-wooden-dessert-stand",
        name: "3 Tier Wooden Dessert Stand",
        price: 3000,
        unit: "each",
        image: woodenDessertStand,
        description: "Rustic 3 tier wooden dessert stand",
      },
      {
        id: "3-tier-dessert-marble-design",
        name: "3 Tier Dessert Marble Design",
        price: 3000,
        unit: "each",
        image: marbleDessertStand,
        description: "Elegant 3 tier dessert stand with marble design",
      },
      {
        id: "fruit-stand",
        name: "Fruit Stand",
      ...
      {
        id: "black-dessert-stand",
        name: "Black Dessert Stand",
        price: 3000,
        unit: "each",
        image: blackDessertStand,
        description: "Sleek black dessert stand",
      },
      {
        id: "white-gold-rim-dessert-tray",
        name: "White with Gold Rim Dessert Tray",
        price: 1500,
        unit: "each",
        image: whiteGoldRimTray,
      ...
      {
        id: "gold-dessert-tray",
        name: "Gold Dessert Tray",
        price: 1500,
        unit: "each",
        image: goldDessertTray,
        description: "Luxurious gold dessert tray",
      },
      {
        id: "basket-dessert-tray",
        name: "Basket Dessert Tray",
        price: 1500,
        unit: "each",
        image: basketDessertTray,
        description: "Charming basket-style dessert tray",
      },
      {
        id: "rectangular-tray",
        ...
        price: 300,
        unit: "each",
        image: rectangularTray,
        description: "Elegant rectangular tray",
      },
      {
        id: "round-tray",
        name: "Round Tray",
        ...
        unit: "each",
        image: roundTray,
        description: "Elegant round tray",
      },
    ...
    items: [
      {
        ...
        unit: "each",
        image: goldTrolleys,
        description: "Luxurious gold trolley for elegant service",
      },
      {
        id: "silver-trolley",
        name: "Silver Trolley",
        ...
        unit: "each",
        image: silverTrolley,
        description: "Sleek silver trolley for stylish service",
      },
    ].sort((a, b) => a.name.localeCompare(b.name)),
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        image: shotGlass,
        description:
          "Compact shot glass (smaller in real life than appears in picture)",
      },
    ].sort((a, b) => a.name.localeCompare(b.name)),
  },
  {
