...
export const categoriesData = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        unit: 'each',
        image: goldRectangle,
        description: 'Available in single, double and triple pans, 9 litres capacity'
      },
      {
      ...
      },
      {
        ...
        description: 'Available in single, double and triple divider pans, 9 litres capacity'
      },
      {
...
export const faqData = [
  {
    ...
    answer: "Yes, you can book items for multiple dates. Please specify each date when placing your order so we can check availability for all requested dates."
  },
  // Add more FAQs...
]
...
export const termsData = [
  [
    { number: 1, text: "All items must be returned in good condition, loss/ damaged Goods will be paid for in full." },
    { number: 2, text: "Customers are required to inspect their goods before collection as we would not be held liable/ accountable for any items once it has left the store." },
    // Add more terms...
  ],
